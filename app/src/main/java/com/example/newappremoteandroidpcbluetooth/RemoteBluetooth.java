...
public class RemoteBluetooth extends AppCompatActivity {
    ...
    // BluetoothChatService Handler message types
    ...
    // BluetoothCommandService Handler Key names received
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get reference to the TextView performing as mousepad
                ...
                if (isConnected && mCommandService != null) {
                    switch (event.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            // when user touches the TextView save X and Y positions
                            initX = event.getX();
                            initY = event.getY();
                            mouseMoved = false;
                            break;
    ...
    protected void onStart() {
        ...
        // else set up the command service
        else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.scan) {
            // Launch the DeviceListActivity to see devices and scan
            Intent serverIntent = new Intent(this, DeviceListActivity.class);
            startActivityForResult(serverIntent, REQUEST_CONNECT_DEVICE);
            return true;
        }
        if (item.getItemId() == R.id.discoverable) {
            // attempt this device is discoverable by others
            ensureDiscoverable();
            return true;
        }
        return false;
